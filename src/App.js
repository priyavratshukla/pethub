...
const AuthNavLinks = withRouter(
  ...
  (sessionStorage.getItem('key-petpeers-userId') && (sessionStorage.getItem('key-petpeers-userId') !== "undefined")) ? (
        <ul>
          <li>Welcome <span id="username">{sessionStorage.getItem('key-petpeers-username')}</span></li>
          <li><Link to="/myaccount">My Account</Link></li>
          <li><Link to="/pets">All Pets</Link></li>
          <li><Link to="/mypet">My Pets</Link></li>
          <li><Link to="/addpet">Add Pet</Link></li>
          <li><a href="javascript:void(0);" onClick={() => { fakeAuth.signout(() => history.push("/")); }} > Sign out </a></li>
        </ul>  
    ) : ( 
      <ul>
